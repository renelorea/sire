...
def login():
    ...
    if usuario and verificar_contraseña(contraseña, usuario['contrasena']):
        ...
        return jsonify(access_token=token, usuario={"id": usuario['id_usuario'], "nombres": usuario['nombres'],"apellido_paterno": usuario['apellido_paterno'],"apellido_materno": usuario['apellido_materno'], "rol": usuario['rol']})
